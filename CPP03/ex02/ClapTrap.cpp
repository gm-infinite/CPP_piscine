...
void ClapTrap::Attack(const std::string& Target)
{
	...
	if (this->GetHitpoints() < 1)
		std::cout << "ClapTrap " << name << " can't do anything because it has no Hit points" << std::endl;
	else if (energypoints < 1)
		std::cout << "ClapTrap " << name << " can't do anything because it has no Energy points" << std::endl;
	else
	{
